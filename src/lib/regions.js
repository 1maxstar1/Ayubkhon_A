...
(function (S) {
   ...
   */
  var NAME = {
    respublika: 'OBSHCHERESPUBLIKANSK OBSHERESPUBLIKANSK UMUMRESPUBLIKA RESPUBLIKAMIZ ' +
      'ELCHIXONA ELCHIXONASI POSOLSTV',
    andijon: 'ANDIJ ANDIZH',
    buxoro: 'BUXORO BUXAR BUHOR BUKHAR',
    fargona: 'FARGON FERGAN FARGHON FERGHAN',
    jizzax: 'JIZZA ZHIZZA DZHIZAK DJIZAK',
    xorazm: 'XORAZM XOREZM',
    namangan: 'NAMANGAN',
    navoiy: 'NAVOIY NAVOIYSK NAVOINSK NAVOI',
    qashqadaryo: 'QASHQADAR KASHKADAR QASHKADAR KASHQADAR',
    samarqand: 'SAMARQ SAMARK',
    sirdaryo: 'SIRDAR SYRDAR',
    surxondaryo: 'SURXAND SURXOND SURHOND SURHAND SURKHAND SURKHOND',
    toshkent_vil: 'TASHKENTSKAYA TASHKENTSKOY TASHKENTSKOM TOSHKENTVILOYAT',
    qoraqalpogiston: 'QORAQALPO KARAKALP QARAQALP KORAKALP',
    toshkent_sh: 'TASHKENTA TASHKENTE'
  };

  var PLACE = {
    andijon: 'ASAKA BALIQCHI BALIKCHI IZBOSKAN IZBASKAN SHAHRIXON SHAXRIXON SHAXRIXAN ULUGNOR ' +
      'JALAQUDUQ ZHALAQUDUQ ZHALAKUDUK DZHALAKUDUK XODZHAABAD KURGONTEPA KURGANTEPA ' +
      'ALTINKUL MARXAMATSK',
    buxoro: 'BUXORO KOGON KAGAN GIJDUV GIZHDUV JONDOR ZHONDOR OLOT PESHK ROMITAN SHOFIRKON ' +
      'SHAFIRKAN QORAKOL QORAKUL KORAKUL KARAKULSK QOROVULBOZOR KARAULBAZAR VOBKENT VABKENT ' +
      'ALATSK GALAOSIY',
    fargona: 'MARGILON MARGILAN QOQON KOKAND QUVASOY KUVASAY RISHTON RISHTAN BESHARIQ BESHARIK ' +
      'BUVAYDA DANGARA OLTIARIQ ALTIARIK UCHKOPRIK UCHKUPRIK YOZYOVON EZEVON YAZYAVAN ' +
      'BAGDOD BOGDOD BAGDAD QUVA KUVA SOX QAQIR',
    jizzax: 'GALLAOROL GALLYAARAL ZOMIN ZAAMIN BAXMAL BAHMAL FORISH MIRZACHOL DASHTOBOD ' +
      'SANGZOR USMAT ARNASOY',
    xorazm: 'URGANCH URGENCH XIVA KHIVA XIVINSK BOGOT BAGATSK GURLAN GURLEN XONQA XONKA XANKA ' +
      'HONQA HAZORASP XAZORASP XAZARASP SHOVOT SHAVAT QOSHKOPIR KOSHKOPIR QOSHKUPIR KOSHKUPIR ' +
      'TUPROQQAL TUPROKKAL PITNAK YANGIARIKSK YANGIBAZARSK',
    namangan: 'CHUST CHORTOQ CHARTAK CHORTOK KOSONSOY KASANSAY TORAQORGON TURAKURGAN UCHQORGON ' +
      'UCHKURGAN UYCHI DAVLATOBOD NORIN NARIN POP PAPSK CHODAK TOSHBULOQ MINGBULAK',
    navoiy: 'XATIRCH HATIRCH QIZILTEP KIZILTEP KARMAN KONIMEX NUROTA NURATIN TOMDI TAMDINSK ' +
      'UCHQUDU UCHKUDU GOZGON GAZGON GAZGAN NAVBAXORSK ZARMITANSK SENTOB',
    qashqadaryo: 'QARSHI KARSHI SHAHRISABZ SHAXRISABZ KITAB KITOB KOSON KASBI CHIROQCHI ' +
      'CHIRAKCHI DEHQONOBOD DEHKANABAD MIRISHKOR MUBORAK MUBAREK NISHON QAMASHI KAMASHI ' +
      'YAKKABOG YAKKABAG SHURTAN KOKDALA BESHKENT',
    samarqand: 'KATTAQORG KATTAQURG KATTAKURG KATTAKORG URGUT BULUNGUR ISHTIX JOMBOY DZHAMBAY ' +
      'QOSHRAB NARPAY OQDARYO AKDARYA PASTDARG PAXTACHI PAYARI TOYLOQ TAYLYAK ZIRABULOQ ' +
      'ZIRABULAKSK PAYSHANBA KONIGIL DAHBED DAXBED CHELAK LOYISH XISHRAV ZIYOVUDDIN',
    sirdaryo: 'GULIST GULISTANSK YANGIYER YANGIER BOYOVUT BAYAUT SARDOBA SAYXUN SAYHUN ' +
      'MIRZAOBOD MIRZAABAD OQOLTIN AKALTIN XOVOS XAVAST XAVASTSK',
    surxondaryo: 'TERMIZ TERMEZ DENOV DENAU BOYSUN BAYSUN SHEROBOD SHIRABAD SARIOSI ' +
      'JARQORGON ZHARQORGON DZHARKURGAN QUMQORGON KUMKURGAN SHORCHI SHURCHI OLTINSOY ' +
      'QIZIRIQ KIZIRIK MUZRABOT BANDIXON ANGOR TOPALANG SHARGUN',
    toshkent_vil: 'ANGREN BEKOBOD BEKABAD BEKINSK CHIRCHI PARKENT PISKENT PSKENT OLMALIQ ALMALIK ' +
      'OHANGARON OXANGARON AHANGARON AXANGARAN YANGIYOL YANGIYUL GAZALKENT ZANGIOTA ' +
      'BOSTONLIQ BUSTONLIQ BOSTANLIK CHINOZ CHINAZ QIBRAY KIBRAY OQQORGON AKKURGAN ' +
      'QUYICHIRCHIQ KUYICHIRCHIK ORTACHIRCHIQ URTACHIRCHIK YUQORICHIRCHIQ YUKORICHIRCHIK ' +
      'TOYTEPA TUYTEPA BOKA BUKA BUKINSK CHORVOQ CHIMGAN XUMSON',
    qoraqalpogiston: 'NUKUS NOKIS CHIMBOY CHIMBAY SHIMBAY KEGEYLI KEGAYLI ELLIKQAL ELLIKKAL ' +
      'MOYNOQ MUYNOQ MUYNAK QANLIK QONLIK KANLIK KONLIK QONGIROT QUNGIROT KONGIROT KUNGIROT ' +
      'KUNGRAD QORAOZ QARAOZ KARAUZ SHUMANAY SHUMANOY SHOMANAY SHOMANOY TAXTAKOPIR ' +
      'TAXTAKUPIR TORTKOL TORTKUL TURTKUL XOJAYLI XOZHAYLI HODJEYLI TAXIATOSH TAXIATASH ' +
      'BERUNIYSK AMUDARINSK USTYURT ZHASLIK OQMANGIT AKMANGIT BOZAT BUZAT',
    toshkent_sh: 'CHILONZOR CHILANZAR YUNUSOBOD YUNUSABAD MIROBOD MIRABADSK YAKKASAROY ' +
      'YAKKASARAY SHAYXONTOHUR SHAYXONTOXUR SHAYXANTAXUR SHAYHANTAHUR SHAYHONTOHUR ' +
      'ALMAZARSK UCHTEPIN BEKTEMIR SERGELI SERGILI YASHNOBOD YASHNABADSK ULUGBEKSK ' +
      'METROPOLITEN',
    respublika: ''
  };
   ...
   *
   * An exact list, and Uzbek declines these words endlessly — кўчасини,
   * кўчасининг, кўчасидан, кўчаларида, махалласини. Measured before widening
   * it to a stem match: the registry's 1247 applications carry 42 such
   * spellings the list does not have, 150 times over; nine of them stand right
   * after a name in the gazetteer, and not one changes the answer, because
   * every one of those rows also names its district — «Чилонзор тумани
   * Арнасой кўчасидаги», «Миробод тумани … Нукус кўчасидан» — and a district
   * outweighs a street. So the list stays as it is: a stem match would buy
   * nothing here and would have to be taught that КЎЧАТ is a sapling.
   */
  var SKIP_BEFORE = {
  ...
  function scanInto(score, evidence, order, text, weight) {
    ...
    for (i = 0; i < toks.length; i++) {
      ...
      if (!bucket) {
        // Not in the gazetteer. «Тошкент» on its own is the one name that
        // belongs to two regions at once; settle it after the loop, once it is
        // known whether a district of either was named outright. The inflected
        // forms — Ташкента, Ташкентской — are gazetteer entries and never get
        // here, because only they say which of the two is meant.
        if (TASHKENT.test(tok)) bare.push(i);
        continue;
      }
