...
await page.waitForFunction(() => document.getElementById('regStat').textContent.includes('строк'), null, { timeout: 15 * 60000 });
...
t = Date.now();
await page.setInputFiles('#regFile', registry);
await page.waitForFunction(() => document.getElementById('regStat').textContent.includes('обновлено 2'), null, { timeout: 15 * 60000 });
...
await page.waitForFunction(() => document.getElementById('toast').textContent.includes('сохранён на сервере'), null, { timeout: 120000 });
